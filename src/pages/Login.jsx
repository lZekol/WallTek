...
function Login() {
    ...
    /* Misafir için: favoriler veya korumalı sayfalardan gelince / 'e yönlendir */
    const guestDestination = ["/wishlist", "/profile", "/orders", "/checkout"].includes(from)
        ? "/"
        : from
    ...
    const handleLogin = async () => {
        ...
        setLoading(false)
        if (error) setErrors({ general: "E-posta veya şifre hatalı." })
        else navigate(from)
    }
    ...
    const handleRegister = async () => {
        ...
        else setErrors({ success: "Kayıt başarılı! Giriş yapabilirsiniz." })
    }
    ...
    /* ✅ Misafir: korumalı sayfalardan geldiyse / 'e gönder */
    const guestLogin = () => {
    ...
    return (
        <section className="loginPage">
            <div className="loginBox">
                ...
                <button className={`loginBtn${loading ? " loading" : ""}`} onClick={handleLogin} disabled={loading}>
